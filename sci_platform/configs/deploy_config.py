...
# deploy setups
use_ollama = True
ips = ['paraai-n32-h-01-agent-62','paraai-n32-h-01-agent-101','paraai-n32-h-01-agent-104','paraai-n32-h-01-agent-190','paraai-n32-h-01-agent-199','paraai-n32-h-01-agent-219','127.0.0.1']
